            ...
            $.ajax({
                    ...
                    success: (results) => {
                        ...
                        if (data.length == 0) {
                            ...
                            $('#productSearchResults').append('Product not found!').addClass('s-flex justify-content-center alert alert-warning')
                        } else{
                    ...
                    html += `<a href="/api/product/getproductbyid/${data[i]._source._id}" class="btn btn-primary">Shop</a>`
                    html +=  '</div>'
                    html +=  '</div>'
